...
description: "Pay-as-you-go SaaS for AI-driven multimedia captioning and transcription, built end-to-end with SST, Hono, AWS, LangChain, and Polar billing."
tags: AI, ASR, React, TypeScript, Hono, SST, AWS, Monorepo, PostgreSQL, Prisma, Better Auth, Polar, LangChain, Qwen, DashScope
startDate: Apr 2026
endDate: Jun 2026
sorting: 5
cover: /projects/covers/project_11_cover.png?v=1
---
